...
public class SortFloat64sAreSorted extends Recipe {

    @Override
    public String getDisplayName() {
        return "Use sort.Float64sAreSorted";
    }

    @Override
    public String getDescription() {
        return "Migrates `sort.IsSorted(sort.Float64Slice(x))` to `sort.Float64sAreSorted(x)`.";
    }
                        ...
                        if (arg instanceof CallExpr) {
                            ...
                            if (argCall.getFun() instanceof SelectorExpr) {
                                ...
                                if (argSel.getX() instanceof Ident && "sort".equals(((Ident) argSel.getX()).getName()) && "Float64Slice".equals(argSel.getSel().getName())) {
                                    ...
                                    Ident newIdent = sel.getSel().withName("Float64sAreSorted");
