...
public class StringsIndexAnyToContainsAny extends Recipe {

    @Override
    public String getDisplayName() {
        return "Use strings.ContainsAny instead of strings.IndexAny >= 0";
    }

    @Override
    public String getDescription() {
        return "Converts `strings.IndexAny(s, sub) >= 0` to `strings.ContainsAny(s, sub)`.";
    }
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new GoVisitor<ExecutionContext>() {
            ...
            private boolean isStringsIndexAnyCall(CallExpr call) {
