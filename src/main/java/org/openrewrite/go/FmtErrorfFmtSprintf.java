...
public class FmtErrorfFmtSprintf extends Recipe {

    @Override
    public String getDisplayName() {
        return "Use fmt.Errorf directly instead of fmt.Errorf(fmt.Sprintf())";
    }

    @Override
    public String getDescription() {
        return "Migrates `fmt.Errorf(fmt.Sprintf(format, args...))` to `fmt.Errorf(format, args...)`.";
    }
                        ...
                        if (arg instanceof CallExpr) {
                            ...
                            if (argCall.getFun() instanceof SelectorExpr) {
                                ...
                                if (argSel.getX() instanceof Ident && "fmt".equals(((Ident) argSel.getX()).getName()) && "Sprintf".equals(argSel.getSel().getName())) {
                                    ...
                                    return c.withArgs(argCall.getArgs());
                                }
                            }
                        }
                    }
