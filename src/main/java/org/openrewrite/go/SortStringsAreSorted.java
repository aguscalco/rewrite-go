...
public class SortStringsAreSorted extends Recipe {

    @Override
    public String getDisplayName() {
        return "Use sort.StringsAreSorted";
    }

    @Override
    public String getDescription() {
        return "Migrates `sort.IsSorted(sort.StringSlice(x))` to `sort.StringsAreSorted(x)`.";
    }
                        ...
                        if (arg instanceof CallExpr) {
                            ...
                            if (argCall.getFun() instanceof SelectorExpr) {
                                ...
                                if (argSel.getX() instanceof Ident && "sort".equals(((Ident) argSel.getX()).getName()) && "StringSlice".equals(argSel.getSel().getName())) {
                                    ...
                                    Ident newIdent = sel.getSel().withName("StringsAreSorted");
