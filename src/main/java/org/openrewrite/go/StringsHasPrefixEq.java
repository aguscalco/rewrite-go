...
public class StringsHasPrefixEq extends Recipe {

    @Override
    public String getDisplayName() {
        return "Use strings.HasPrefix over strings.Index == 0";
    }

    @Override
    public String getDescription() {
        return "Migrates `strings.Index(s, \"prefix\") == 0` to `strings.HasPrefix(s, \"prefix\")`.";
    }
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new GoVisitor<ExecutionContext>() {
            ...
            public Tree visitBinaryExpr(BinaryExpr binaryExpr, ExecutionContext ctx) {
                ...
                if ("==".equals(b.getOp())) {
                    if (b.getX() instanceof CallExpr && b.getY() instanceof BasicLit) {
                        ...
                        if ("0".equals(lit.getValue()) && isStringsIndex(call)) {
            ...
            private boolean isStringsIndex(CallExpr call) {
