...
class BytesReplaceZeroTest {

    @Test
    void migratesBytesReplaceZero() {
        ...
        Ident newIdent = new Ident(UUID.randomUUID(), Space.EMPTY, Markers.EMPTY, "newBytes", null);
        ...
        BytesReplaceZero recipe = new BytesReplaceZero();
