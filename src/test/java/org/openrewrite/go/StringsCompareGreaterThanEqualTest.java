...
class StringsCompareGreaterThanEqualTest {

    @Test
    void migratesStringsCompareGreaterThanEqual() {
        ...
        StringsCompareGreaterThanEqual recipe = new StringsCompareGreaterThanEqual();
