...
class SortIntsAreSortedTest {

    @Test
    void migratesIntsAreSorted() {
        ...
        CallExpr sliceCall = new CallExpr(UUID.randomUUID(), Space.EMPTY, Markers.EMPTY, intSliceSel, Collections.singletonList(xIdent), false, null);
        ...
        SortIntsAreSorted recipe = new SortIntsAreSorted();
        ...
        assertEquals("IntsAreSorted", resSel.getSel().getName());
