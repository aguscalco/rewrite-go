...
class SortIntsToSlicesSortTest {

    @Test
    void migratesSortInts() {
        Ident sortIdent = new Ident(UUID.randomUUID(), Space.EMPTY, Markers.EMPTY, "sort", null);
        Ident intsIdent = new Ident(UUID.randomUUID(), Space.EMPTY, Markers.EMPTY, "Ints", null);
        SelectorExpr sel = new SelectorExpr(UUID.randomUUID(), Space.EMPTY, Markers.EMPTY, sortIdent, intsIdent, null);
        ...
        SortIntsToSlicesSort recipe = new SortIntsToSlicesSort();
