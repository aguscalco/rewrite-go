...
class StringsSplitNToSplitTest {

    @Test
    void migratesStringsSplitN() {
        ...
        SelectorExpr sel = new SelectorExpr(UUID.randomUUID(), Space.EMPTY, Markers.EMPTY, stringsIdent, splitNIdent, null);
        ...
        StringsSplitNToSplit recipe = new StringsSplitNToSplit();
